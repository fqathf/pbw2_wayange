...
<header class="flex items-center justify-between py-4 px-8 bg-white shadow">
        ...
        <nav class="flex space-x-10 text-[#653312]">
            ...
            <a href="#" class="hover:text-brown-800">Kuis</a>
        </nav>
            </h1>
        <div class="flex items-center space-x-4">
            <body class="flex items-center justify-center h-screen bg-[#653312]">
                <button class="bg-[#6c3d1f] text-white font-semibold py-2 px-6 rounded-full hover:bg-[#5a331a] transition duration-300">Login</button>
            </body>
            <body class="px-4 py-2">
                <p class="text-1xl text-[#5a331a] font-['Moanrope']">
                <button class="bg-white text-brown font-semibold py-2 px-6 rounded-full hover:bg-[#5a331a] hover:text-white transition duration-300 border border-gray-300">
                    Daftar Sekarang
                </button>
                </p>
            </body>
