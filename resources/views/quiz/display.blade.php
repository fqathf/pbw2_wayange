    ...
    <section class="bg-[url('{{ asset('assets/img/bg-hero-md.svg') }}')] bg-cover bg-center overflow-hidden">
      <div class="flex flex-col-reverse sm:flex-row">
        <div class="h-screen w-screen flex justify-center items-center flex-col">
          <h1 class="text-9xl text-center text-[#653312] font-bold tracking-wide font-[playfair]">List<br>Quiz</h1>
          <form class="mt-4 flex flex-col gap-3 md:flex-row z-30" action="{{ route('quiz.search') }}" method="GET">
              @csrf  
