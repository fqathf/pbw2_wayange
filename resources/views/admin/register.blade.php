...
<header class="flex items-center justify-between py-4 px-8 bg-white">
        <div class="flex items-center flex space-x-10">
            ...
            <h1
                class="text-2xl text-[#653312] font-['Montserrat']">
        ...
        <div class="flex items-center space-x-4">
            <button class="flex items-center justify-center bg-white text-[#6c3d1f] rounded-full h-20 w-20 hover:bg-gray-200 transition duration-300">
            ...
            <body class="flex it-center justify-center h-screen bg-[#653312]">
                ...
                <button class="bg-[#6c3d1f] text-white font-semibold py-4 px-6 rounded-full hover:bg-[#5a331a] transition duration-300">Ikuti Kuis Kepribadian</button>
                </p>
            </body>
        </div>
    </header>
    ...
    <div class="flex flex-col items-center justify-center flex-grow px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-xl p-12 mx-auto">
            <h1 
                class="text-3xl font-bold text-[#141111] font-[Space Grotesk] mb-2">
                Sign In
            </h1>
            ...
            <form>
                ...
                <div class="mb-2">
                    ...
                    <input type="email" placeholder="e.g name@gmail.com" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring focus:border-brown-700" />
                </div>
                <div class="mb-2">
                    <label class="font-bold block text-[#141111]">Password</label>
                    <input type="password" placeholder="••••••••" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring focus:border-brown-700" />
                </div>
                <div class="mb-4">
                ...
                <div class="flex items-center justify-center h-fill">
                    <button class="bg-[#6c3d1f] w-full text-white font-semibold py-4 px-8 rounded-2xl hover:bg-[#5a331a] transition duration-300">Sign In</button>
                </div>
                <p class="text-center text-sm text[#695959] mt-4">
                    By Signing up, you'll join our exclusive waiting list to be among the first to try prepintel and provide valuabe feedback before we launch before we launch publicly</a>
                </p>
            </form>
        </div>
    </div>
